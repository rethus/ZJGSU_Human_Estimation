...
from utils import *
from net import DynFilter, DFNet, BMNet

import argparse


def Run(in_filepath_one, in_filepath_two, out_filepath):
    # 解析器 ----------------------------------------------------------------------
    ...
    parser.add_argument('--first', type=str, default=in_filepath_one)
    parser.add_argument('--second', type=str, default=in_filepath_two)
    parser.add_argument('--output', type=str, default=out_filepath)
    ...
    # args ----------------------------------------------------------------------
    # ckpt_bm='Weights/BMNet_weights.pth'
    # ckpt_df='Weights/DFNet_weights.pth'
    # first='images/im1.png'
    # output='images/im2.png'
    # save_flow=False
    # second='images/im3.png'
    # time_step=0.5
    # vis_flow=False)
    ...
    with torch.no_grad():
        ...
        BM = args.dict['BMNet'](F.interpolate(torch.cat((I0, I1), dim=1), (H_, W_), mode='bilinear'),
                                time=args.time_step)  # V_t_1
